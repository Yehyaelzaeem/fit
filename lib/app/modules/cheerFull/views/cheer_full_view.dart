                        ...
                        child: SizedBox(
                          ...
                          child: Column(
                            children: <Widget>[
                              ...
                              SizedBox(height: 20),
                              if (controller.response.value.data != null && controller.response.value.data!.info != null && controller.response.value.data!.info!.location != null && controller.response.value.data!.info!.location!.isNotEmpty)
                                GestureDetector(
                                  onTap: () {
