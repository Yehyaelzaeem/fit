                ...
                children: [
                  ...
                  table.caloriesTable!.carbsFatsTable!.isNotEmpty ||
                      table.caloriesTable!.proteinsCaloriesTable!
                          .isNotEmpty
                      ? Image.asset('assets/app_logo.png', scale: 14,)
                      : SizedBox(),
                ],
              ),
              children: [
                          ...
                          CustomSheet(
                              ...
                              widget: ListView(
                                ...
                                children: [
                                  ...
                                  Divider(),
                                  Text(
                                    "Workout : ${table.workout != null ? table.workout!
                                        .workoutType : "Not Yet"}",
                                    style: TextStyle(
                                        fontSize: 18,
                                  ...
                                  Text(
                                    "${table.workout != null
                                        ? table.workout!.workoutDesc
                                        : "   "}",
                                    style: TextStyle(fontSize: 14, fontWeight: FontWeight.w500),
                                  ),
                                  Divider(),
                                  Text(
                                    "Sleep time : ${table.sleepingTime != null ? table
                                        .sleepingTime?.sleepingDuration : "Not Yet"}",
                                    style: TextStyle(
                                        fontSize: 18,
                                        fontWeight: FontWeight.bold,
                                        color: kColorPrimary),
                                  ...
                                  Text(
                                    "${table.sleepingTime != null ? table.sleepingTime
                                        ?.sleepingStatus?.name : "   "}",
                                    style: TextStyle(fontSize: 14, fontWeight: FontWeight.w500),
                                  ),
                                  Divider(),
                                  ...
                                  table.caloriesTable!.proteinsCaloriesTable!.isEmpty
                                    ...
                                    child: Center(
                                      ...
                                      physics: NeverScrollableScrollPhysics(),
                                      itemCount:
                                      table.caloriesTable!.proteinsCaloriesTable!.length,
                                      itemBuilder: (context, inIndex) {
                                        return rowItem(table
                                            .caloriesTable!.proteinsCaloriesTable![inIndex]);
                                      }),
                                  Divider(),
                                  Text(
                                    "Carbs",
                                  ...
                                  table.caloriesTable!.carbsFatsTable!.isEmpty
                                    ...
                                    child: Center(
                                      ...
                                      itemBuilder: (context, inIndex) {
                                        return rowItem(
                                            table.caloriesTable!.carbsFatsTable![inIndex]);
                                      }),
                                  Divider(),
                                  Text(
                                    "Fats",
                                  ...
                                  table.caloriesTable!.fatsTable!.isEmpty
                                    ...
                                    child: Center(
                                      ...
                                      shrinkWrap: true,
                                      physics: NeverScrollableScrollPhysics(),
                                      itemCount: table.caloriesTable!.fatsTable!.length,
                                      itemBuilder: (context, inIndex) {
                                        return rowItem(
                                            table.caloriesTable!.fatsTable![inIndex]);
                                      }),
                                ],
                              ));
                        })),
