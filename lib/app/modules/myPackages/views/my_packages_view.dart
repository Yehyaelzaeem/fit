                  ...
                  child: Column(
                          ...
                          children: [
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                kTextHeader("Completed payment",color: kColorPrimary),
                              ],
                            ),
                            SizedBox(height: 18),
                    ...
                    child: Center(
                      child: Container(
                        ...
                        child: Stack(
                          children: [
                            Center(child: kTextHeader('  subscribe new package  ', size: 16, color: Colors.white, bold: true, paddingH: 16, paddingV: 4)),
                            Positioned(
                              left: 12,
                              top: 0,
                              bottom: 0,
