...
import '../repositories/make_meals_repository.dart';

part 'make_meals_states.dart';

class MakeMealsCubit extends Cubit<MakeMealsStates> {
  final MakeMealsRepository _makeMealsRepository;

  MakeMealsCubit(this._makeMealsRepository) : super(MakeMealsInitialState());
