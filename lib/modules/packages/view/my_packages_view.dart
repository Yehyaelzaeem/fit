    ...
    return Container(
      ...
      child: SafeArea(
                  ...
                  child: SizedBox(
                    ...
                    child: ListView.separated(
                                ...
                                children: [
                                  ...
                                  Row(
                                    children: [
                                      ...
                                      kTextHeader(
                                          "${state.myPackagesResponse.data?.orders?[index].price.toString() ?? ""} LE",
                                          color: Colors
                                              .black,
                                          align:
                                          TextAlign
                                    ...
                                    children: [
                                        ...
                                        child: Center(
                                          child: Row(
                                            ...
                                            MainAxisAlignment
                                                .center,
                                            children: [
                                              state.myPackagesResponse.data!.orders![index].paymentStatus!.contains('confirmed')
                                                  ? Icon(Icons.check_circle,
                                                  size: 16,
                                                  color: kColorPrimary)
                                                  : Icon(Icons.error, size: 16, color: AppColors.kRedColor),
                                              kTextHeader(
                                                  state.myPackagesResponse.data?.orders?[index].paymentStatus == ""
                                                      ? ""
                                                      : state.myPackagesResponse.data!.orders![index].paymentStatus!.contains("confirmed")
                                                      ? "Successful"
                                                      : "Failed",
                                                  ...
                                                  paddingH: 8,
                                                  align: TextAlign.start,
                                                  color: state.myPackagesResponse.data!.orders![index].paymentStatus!.contains('confirmed') ? kColorPrimary : AppColors.kRedColor),
                                            ],
                                          ),
                                        ),
                                      ),
                                      ...
                                      index]
                                        ...
                                        Center(
                                          ...
                                          GestureDetector(
                                            onTap:
                                              ...
                                              Navigator.pushReplacement(
                                                  ...
                                                  MaterialPageRoute(
                                                      builder: (_) => InvoiceView(
                                                        packageId: state.myPackagesResponse.data?.orders?[index].id,
                                                      )));
                                            },
                                            child:
                                            Center(
                                          ...
                                          : state.myPackagesResponse.data?.visaStatue ==
                                          true
                                          ? Expanded(
                                        child:
                                        Center(
                                          child: GestureDetector(
                                            onTap: state.myPackagesResponse.data?.orders?[index].paymentUrlStatus == true
                                                ? () {
                                              Navigator.pushReplacement(
                                                  context,
                                                  MaterialPageRoute(
                                                      builder: (_) => WebViewScreen(
                                                        url: state.myPackagesResponse.data!.orders![index].paymentUrl!,
                                                        packageId: state.myPackagesResponse.data!.orders?[index].id!,
                                                      )));
                                            }
                                                : () {
                                            ...
                                            child: Center(
                                              child: Container(
                                                decoration: BoxDecoration(color: state.myPackagesResponse.data?.orders?[index].paymentUrlStatus == true ? kColorPrimary : AppColors.ACCENT_COLOR, borderRadius: BorderRadius.circular(64), boxShadow: [
                                                  BoxShadow(
                                                    color: Colors.grey.withOpacity(0.4),
                                                    blurRadius: 1,
                                                    spreadRadius: 1,
                                          ...
                                          : (state.myPackagesResponse.data?.applePayStatus == true &&
                                          Platform.isIOS)
                                          ? Expanded(
                                        child: Center(
                                          child: GestureDetector(
                        ...
                        separatorBuilder: (context, index) =>
                            SizedBox(height: 12),
                        itemCount: state.myPackagesResponse
                            .data!.orders!.length),
                  ),
                ),
                state.myPackagesResponse.data!.subscriptionStatus == true
                    ? GestureDetector(
                  onTap: () async {
                    ...
                    //               EditProfileView()));
                    // } else {
                    //   NavigationService.push(context,Routes.subscribeView,
                    //       arguments: null);
                    // }
                  },
                  child: Center(
        ...
        MainUnAuth(
            isGuest: true,
            paymentStatus:
            state.myPackagesResponse.data!.subscriptionStatus)
            :Expanded(
          child: Padding(
            padding: EdgeInsets.only(top: deviceHeight * 0.2),
            child: Column(
